...
if __name__ == '__main__':
    ...
    liuanren.keep_shui("http://bbs.luanren.com/forum.php?mod=viewthread&tid=5592588&extra=page%3D1")
    exit()
    # articles = liuanren.get_newpost()
    # articles = liuanren.get_wenhua()
    # articles = liuanren.get_yuer()
    # articles = liuanren.guanshui() #水贴
    # articles = liuanren.get_memberphoto() #会员相册
    # articles = liuanren.get_mmphoto() #会员相册 MM照片
    ...
    #         continue
    #     msgs = [u"小手一抖，经验到手。楼主写的不错。2016新年快乐",
    ...
    for article in articles:
        ...
        liuanren.down_img(article['href'])

        continue

        # liuanren.get_imgsrc(article['href'])
